...
$msvcbin = "msvc\VC\Tools\MSVC\*\bin\Hostx64\x64"
$linkerdeps = @("link.exe", "tbbmalloc.dll", "msvcp140.dll", "msvcp140_atomic_wait.dll", "vcruntime140.dll", "vcruntime140_1.dll", "msvcdis140.dll", "pgodb140.dll", "mspdbcore.dll")
foreach($file in $linkerdeps) {
	cp "$msvcbin\$file" "build\linker\$file"
}
